...
/// <summary>
/// Utility class for logging and visualizing OCR performance metrics.
/// Provides functionality to create Excel reports with execution times, memory usage,
/// and embeddings visualization for OCR preprocessing and extraction methods.
/// </summary>
public static class ExecutionTimeLogger
{
    /// <summary>
    /// Creates a detailed Excel report showing execution times and memory usage for preprocessing methods and OCR tools.
    /// Generates visualizations with charts to help identify the most efficient methods.
    /// </summary>
    /// <param name="filePath">Path where the Excel report will be saved</param>
    /// <param name="preprocessingTimes">List of preprocessing method performance metrics</param>
    /// <param name="ocrExecutionTimes">List of OCR tool performance metrics</param>
    ...
    /// <summary>
    /// Creates a visualization of text embeddings to compare OCR results in a semantic space.
    /// Uses dimensionality reduction to plot high-dimensional text embeddings in 2D scatter plot.
    /// </summary>
    /// <param name="excelFilePath">Path where the Excel file with visualization will be saved</param>
    /// <param name="embeddings">List of text embeddings (vector representations of OCR results)</param>
    /// <param name="ocrSteps">List of labels for each embedding (e.g., OCR method names)</param>
    ...
    /// <summary>
    /// Performs dimensionality reduction on high-dimensional vectors to create 2D representations.
    /// Uses a simplified PCA-like approach to project vectors into a 2D space for visualization.
    /// </summary>
    /// <param name="vectors">List of high-dimensional vectors (text embeddings)</param>
    /// <returns>List of 2D coordinate arrays representing the reduced vectors</returns>
    private static List<double[]> ReduceDimensionality(List<double[]> vectors)
    {
        ...
        // Note: In a production environment, a proper linear algebra library would be used
